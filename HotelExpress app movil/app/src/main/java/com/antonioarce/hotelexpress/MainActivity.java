    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<List<Oferta>> apiModelCall = service.getResponse();
                apiModelCall.enqueue(new Callback<List<Oferta>>() {
                    @Override
                    public void onResponse(Call<List<Oferta>> call, Response<List<Oferta>> response) {
                        adapter.ofertas = response.body();
                        adapter.notifyDataSetChanged();
                    }

                    @Override
                    public void onFailure(Call<List<Oferta>> call, Throwable t) {
                        Log.e("Error operation","Error operation: " +t.getMessage());
                    }
                });
            }
        });
        ...
        adapter = new Adapter(new ArrayList<Oferta>());
